...
class ResNet(nn.Module):
    ...
    def _make_layer(
        ...
        layers = []
        layers.append(
            block(self.inplanes, planes=planes, stride=stride, downsample=downsample)
        )
    ...
    def load_pretrained_weights(self, pretrain_code):
        ...
        state_dict = model_zoo.load_url(
            model_urls[self.model_name], model_dir=model_dir
        )
