...
def load_model(path, iscuda, args):
    ...
    net.preprocess = dict(
        mean=[0.5, 0.5, 0.5], std=[0.5, 0.5, 0.5], input_size=args.image_size
    )
...
if __name__ == "__main__":
    ...
    # Model options
    parser.add_argument(
        "--arch", type=str, required=True, help="Model architecture for testing"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.25,
        help="whitening power, default is 0.25 (i.e., 4th root)",
    )
    parser.add_argument(
        "--whitenv",
        type=int,
